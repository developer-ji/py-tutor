data = {
    ...
    "sources": [
        ...
        {"a":"b",
        "name":"nisha",
                    "description": "Descubra a seção brasileira da Blasting News, a primeira revista feita pelo  público, com notícias globais e vídeos independentes. Junte-se a nós e torne- se um repórter. nisha",
            "url": "https://br.blastingnews.com",
            "nisha": "general",
            "language": "pt",
            "country": "br"
...
c = 0
# pure data me nisha name ka word aya hai ya  nhi ye nikalna hai

for k,v in data.items():# nisha name
    if q in k:
        c += 1
    if type(v) == str:
        if q in v: c += 1
...
print("your query '",q,"' is ",c, " times in the data")